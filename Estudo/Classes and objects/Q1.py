...
# • Crie um programa que utilize esta classe. Ele
#
# deve pedir ao usuário que informe as
# medidas de um triangulo. Depois, deve criar
# um objeto com as medidas e imprimir sua
# área e maior lado.
